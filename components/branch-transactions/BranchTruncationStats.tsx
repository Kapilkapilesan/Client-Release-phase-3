    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {cards.map((card, idx) => (
                <div
                    key={idx}
                    className="group relative bg-card rounded-[2.5rem] border border-border-default p-7 shadow-sm hover:shadow-2xl transition-all duration-500 cursor-default overflow-hidden transform hover:-translate-y-1"
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col mb-6">
                            <div className="flex items-baseline gap-2">
                                <span className="text-[11px] font-black text-text-muted uppercase tracking-widest">LKR</span>
                        ...
                        <div className="flex items-center justify-between pt-5 border-t border-border-default">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[9px] font-black text-text-muted uppercase tracking-widest">{card.trend}</span>
                            </div>
                            <div className="flex gap-1">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="w-1 h-3 rounded-full bg-muted-bg group-hover:bg-primary-500/10 transition-all duration-700"
