...
export function StaffDetailsModal({
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-[110] p-4 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-card rounded-[2.5rem] max-w-2xl w-full shadow-2xl border border-border-default/50 overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-500">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-8 pt-10">
                    <div className="space-y-10">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 pb-8 border-b border-border-default/50">
                            <div
                                className="w-24 h-24 rounded-[2rem] flex items-center justify-center flex-shrink-0 overflow-hidden border-4 border-card shadow-xl relative group"
                                ...
                                <div className="pt-8 border-t border-border-default/30">
                                    <div className="flex items-start gap-5">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-muted-bg/20 p-5 rounded-[1.5rem] border border-border-default/30">
                                                {staff.department && (
                                ...
                                <div className="flex items-start gap-5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-2 gap-6 bg-muted-bg/20 p-5 rounded-[1.5rem] border border-border-default/30">
                                                <div>
                ...
                {/* Footer */}
                <div className="p-6 border-t border-border-default/30 flex justify-end bg-card/80 backdrop-blur-md rounded-b-[2.5rem]">
                    <button
                        onClick={onClose}
