                ...
                <table className="w-full border-collapse">
                    ...
                    <tbody className="divide-y divide-border-divider">
                        {complaints.map((complaint) => {
                            ...
                            // Edit/Delete are now strictly for Owners
                            const showEdit = canEdit && (isCreator || isAssignee);
                            const showDelete = canDelete && isCreator;

                            // Resolve/Reject are for Managers OR Owners
                            const canResolve = canManage || (canEdit && (isCreator || isAssignee));
