    ...
    return (
        <div className={`fixed inset-0 bg-black/60 dark:bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4 transition-opacity duration-300 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className={`relative w-full max-w-lg transform transition-all duration-500 ${isVisible ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 translate-y-4'}`}>
                {/* Premium Glass Card - Light: White with subtle shadow | Dark: Deep blue glass with glow */}
                <div className="relative bg-white dark:bg-[#0d2137]/95 backdrop-blur-2xl rounded-3xl shadow-2xl dark:shadow-[0_25px_60px_-15px_rgba(0,132,209,0.4)] overflow-hidden border border-gray-200 dark:border-[#1e3a5f]/80">
                    ...
                    <button
                        ...
                        className="absolute top-6 right-6 z-10 p-2 rounded-xl 
                                   ...
                                   dark:bg-[#132f4c]/60 dark:hover:bg-[#173a5e]/80 dark:border dark:border-[#1e3a5f]
                                   text-gray-600 hover:text-gray-900 
                                   dark:text-[#90caf9] dark:hover:text-[#e3f2fd] 
                    ...
                    <div className="relative px-8 py-12 flex flex-col items-center text-center">
                        ...
                        {/* Date - Light: Muted gray | Dark: Soft blue */}
                        <p className="text-sm font-medium text-gray-500 dark:text-[#5c8ab8] mb-3 tracking-wide uppercase">
                            {currentDate}
                        </p>
                        ...
                        {/* Personalized greeting - Light: Dark gray | Dark: Sky blue */}
                        <p className="text-xl font-semibold text-gray-700 dark:text-[#90caf9] mb-4">
                            Hello, <span className="text-primary-600 dark:text-primary-400 font-bold">{username}</span>!
                        </p>

                        {/* Subtitle - Light: Medium gray | Dark: Muted blue */}
                        <p className="text-base text-gray-600 dark:text-[#5c8ab8] max-w-md mb-8 leading-relaxed">
