                ...
                <div className="flex items-center gap-4 px-6 border-l border-border-default/50 text-right">
                    <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5 justify-end">
                            <span className="text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest">{records.filter(r => r.status === 'approved').length} Awaiting</span>
                                        ...
                                        <td className="px-6 py-4.5 text-center">
                                            <div className="flex flex-col items-center gap-1.5">
                                                <span className={`px-4 py-1.5 rounded-xl text-[9px] font-black border uppercase tracking-[0.15em] transition-all duration-300 shadow-sm min-w-[120px] ${record.status === 'approved'
                                                    ? 'bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 border-amber-100 dark:border-amber-900/30 shadow-amber-100/20 dark:shadow-amber-900/20'
