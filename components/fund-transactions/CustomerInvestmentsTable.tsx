...
export function CustomerInvestmentsTable({ records }: Props) {
    ...
    const getStatusStyle = (status: string) => {
        switch (status) {
            ...
            default: return { bg: 'bg-muted-bg/10', text: 'text-text-muted', border: 'border-border-default' };
        }
    };
    ...
    return (
        <div className="space-y-4">
            <div className="bg-card rounded-[2.5rem] overflow-hidden shadow-2xl border border-border-default">
                <div className="p-8 border-b border-border-default flex items-center justify-between bg-muted-bg/10">
                    ...
                    <table className="w-full text-left border-separate border-spacing-0">
                        <thead>
                            <tr className="bg-muted-bg/40">
                                <th className="px-8 py-6 text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-b border-border-default whitespace-nowrap">Account Hierarchy</th>
                                <th className="px-8 py-6 text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-b border-border-default whitespace-nowrap">Principal Investor</th>
                                <th className="px-8 py-6 text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-b border-border-default whitespace-nowrap">Structure & Return</th>
                                <th className="px-8 py-6 text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-b border-border-default text-right whitespace-nowrap">Active Balance</th>
                                <th className="px-8 py-6 text-[10px] font-black text-text-muted uppercase tracking-[0.2em] border-b border-border-default whitespace-nowrap text-right">Lifecycle</th>
                            </tr>
                        </thead>
                            ...
                            {records.length > 0 ? records.map((record) => {
                                ...
                                return (
                                    <tr
                                        ...
                                        className="group hover:bg-hover transition-all duration-300 cursor-pointer"
                                    >
                                        ...
                                        <td className="px-8 py-6">
                                            <div>
                                                ...
                                                <span className="text-[10px] font-black text-text-muted uppercase tracking-widest bg-muted-bg/50 px-2 py-1 rounded-lg border border-border-default/50">ID: {record.customer?.customer_code}</span>
                                            </div>
                                        </td>
                                        <td className="px-8 py-6">
                                        ...
                                        <td className="px-8 py-6 text-right text-nowrap">
                                            <div className="flex flex-col items-end gap-2">
                                                ...
                                                <div className="flex items-center gap-2 px-2 py-1 bg-muted-bg/50 rounded-lg border border-border-default shadow-inner">
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <div className="flex flex-col items-end gap-2">
                                                <div className="flex items-center gap-2 px-3 py-1.5 bg-muted-bg rounded-2xl border border-border-default group-hover:bg-card transition-colors">
                                ...
                                <tr>
                                    <td colSpan={5} className="px-6 py-20 text-center bg-muted-bg/20">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-[10px] font-black text-text-muted uppercase tracking-[0.2em]">No capital subscriptions detected</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
            ...
            <div className="p-8 bg-muted-bg/10 border-t border-border-default rounded-b-[2.5rem] text-center">
