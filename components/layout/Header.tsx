                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <input
                            ...
                            className="pl-10 pr-4 py-2.5 bg-input border border-transparent dark:border-border-default rounded-xl w-80 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-card focus:border-blue-200 dark:focus:border-blue-600 transition-all text-sm text-text-primary"
                        />
                    </div>
                </div>
