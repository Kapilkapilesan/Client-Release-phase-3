    ...
    return (
        <>
            <div className="bg-card rounded-[2.5rem] shadow-2xl w-full max-w-md overflow-hidden flex flex-col h-fit border border-border-default">
                ...
                <div className={`${isBlocked ? 'bg-rose-600' : 'bg-primary-600'} p-8 relative transition-colors`}>
                    <button
                        onClick={onClose}
                    ...
                    <div className="flex flex-col gap-5">
                        <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center text-white text-2xl font-black backdrop-blur-md border border-white/20 shadow-inner">
                        ...
                        <div>
                            <div className="flex items-center gap-3">
                                ...
                                {isBlocked && (
                                    <span className="bg-white/20 text-white text-[10px] uppercase font-black px-3 py-1 rounded-full border border-white/20 backdrop-blur-md">
                                        Blocked
                                    </span>
                                )}
                            </div>
                    ...
                    <div className="p-8 flex flex-col gap-8">
                        <div className="flex flex-col gap-6">
                            <div className="flex gap-5 group/item">
                                <div className="w-10 h-10 rounded-2xl bg-muted-bg flex items-center justify-center flex-shrink-0 group-hover/item:bg-primary-500/10 transition-colors">
                                    <Phone className="w-5 h-5 text-text-muted/40 group-hover/item:text-primary-500" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-text-muted uppercase tracking-widest opacity-40">Frequency Link</p>
                            ...
                            <div className="flex gap-5 group/item">
                                <div className="w-10 h-10 rounded-2xl bg-muted-bg flex items-center justify-center flex-shrink-0 group-hover/item:bg-primary-500/10 transition-colors">
                                    <Mail className="w-5 h-5 text-text-muted/40 group-hover/item:text-primary-500" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-text-muted uppercase tracking-widest opacity-40">Email Address</p>
                            ...
                            <div className="flex gap-5 group/item">
                                <div className="w-10 h-10 rounded-2xl bg-muted-bg flex items-center justify-center flex-shrink-0 group-hover/item:bg-primary-500/10 transition-colors">
                                    <MapPin className="w-5 h-5 text-text-muted/40 group-hover/item:text-primary-500" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-text-muted uppercase tracking-widest opacity-40">Center</p>
                                    <p className="text-[14px] font-black text-text-primary mt-1 tracking-tight">
                            ...
                            <div className="flex gap-5 group/item">
                                <div className="w-10 h-10 rounded-2xl bg-muted-bg flex items-center justify-center flex-shrink-0 group-hover/item:bg-primary-500/10 transition-colors">
                                    <Building className="w-5 h-5 text-text-muted/40 group-hover/item:text-primary-500" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-text-muted uppercase tracking-widest opacity-40">Branch</p>
                                    <p className="text-[14px] font-black text-text-primary mt-1 tracking-tight">
                        ...
                        <div className="flex flex-col gap-3 mt-2">
                            ...
                            >
                                ...
                                {isBlocked ? 'Re-Initialize Protocol' : 'Disable'}
                            </button>
